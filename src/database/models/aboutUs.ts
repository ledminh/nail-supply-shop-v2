...
export function setAboutUsFooter(footer: string) {
    ...
    return Promise.resolve({success: true, message: 'About us footer updated successfully'});
}

export function setAboutUsMissionStatement(missionStatement: string) {
    aboutUs.missionStatement = missionStatement;

    return Promise.resolve({success: true, message: 'Mission statement updated successfully'});
}

export function setAboutUsHistoryHTML(history: string) {
    aboutUs.historyHTML = history;

    return Promise.resolve({success: true, message: 'History updated successfully'});
}
...
export function setAboutUsContactInfo(email: string, phone: string, additionalInfos?: string[]) {
    ...
    additionalInfos? (aboutUs.contactInfo.additionalInfos = additionalInfos) : null

    return Promise.resolve({success: true, message: 'Contact info updated successfully'});
}
