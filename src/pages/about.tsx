      ...
      <div className={styles.wrapper}>
        ...
        <section className={styles.history}>
          ...
          <div
            ...
            dangerouslySetInnerHTML={{ __html: aboutUsData.historyHTML }}
          />
        </section>
        <section className={styles.contactUs}>
          ...
          <div className={styles.contactInfo}>
            <p className={styles.text}>
              <strong>Email:</strong> {aboutUsData.contactInfo.email}
            </p>
            <p className={styles.text}>
              <strong>Phone:</strong> {aboutUsData.contactInfo.phone}
            </p>
            {aboutUsData.contactInfo.additionalInfos &&
              aboutUsData.contactInfo.additionalInfos.map((info) => (
                <p key={info} className={styles.text}>
                  {info}
                </p>
              ))}
          </div>
