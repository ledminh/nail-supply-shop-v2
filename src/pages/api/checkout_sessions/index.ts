...
export default async (req: NextApiRequest, res: NextApiCheckoutResponse) => {
    if (req.method === "POST") {
        ...
        const params = createStripeParams(orderedProducts, shippingAddress.email, req);        
...
function createStripeParams(orderedProducts: OrderedProduct[], email: string | undefined, req: NextApiRequest) {
