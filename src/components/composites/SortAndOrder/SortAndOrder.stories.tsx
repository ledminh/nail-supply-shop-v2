...
import type { ListCondition, SortItem, SortedOrderItem } from "@/types/list-conditions";
...
const Wrapper = () => {
  ...
  const [currentCondition, setCurrentCondition] = useState<ListCondition|null>(null);
