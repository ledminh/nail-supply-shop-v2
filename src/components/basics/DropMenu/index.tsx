...
const DropMenuCPN: DropMenu = ({
  ...
  const ItemCPN = ({ id, label }: ItemCPNProps) => {
    return (
      <div
        className={styles.item + (itemClass ? " " + itemClass : "")}
        onClick={(e) => {
          e.stopPropagation();
          itemOnClick(id);
        }}
      ...
      >
        ...
        <ImageCPN
          ...
          className={
            ...
            (isOpenedList ? " " + styles.isOpened : "")
          }
          size="small"
        />
      </div>
      <div
        className={styles.body + (isOpenedList ? " " + styles.isOpened : "")}
      >
        <List
          items={items}
          ItemCPN={ItemCPN}
          ...
          activeItem={{
            id: currentItem.id,
            className:
              styles.active + (activeLiClass ? " " + activeLiClass : ""),
          }}
        />
      </div>
    </div>
